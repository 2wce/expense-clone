...
export const PremiumFeatureList = ({ className = '' }) => {
  return (
    <div
      className={`mb-0 ml-1 mt-4 flex flex-col justify-center text-left text-white ${className}`}
    >
  ...
  return (
    <div className="bg-pro-plan mt-8  min-w-[330px] divide-y divide-zinc-600 rounded-lg bg-zinc-900 text-left shadow-sm sm:mt-0">
      <div className="p-5 py-6">
        <h2 className="text-3xl font-extrabold leading-6 text-white">
          Premium
        </h2>
        <p className="font-default mt-2 mb-2 text-zinc-300">
