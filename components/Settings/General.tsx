...
//import importedCurrencies from 'data/currency.json'
...
export default function General({ user }: Props) {
  ...
  return (
    <div className="mt-4 mb-8 w-full max-w-2xl rounded-lg bg-white p-3 text-left shadow shadow-gray-200 md:mt-0">
      <h3 className="p-3 py-3 text-xl font-extrabold leading-6 text-black">
        Account
      </h3>
