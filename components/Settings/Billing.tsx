  ...
  return (
    <div className="mt-8 mb-2 flex w-full flex-col justify-center md:flex-row">
      <div className="mt-4 grid w-full max-w-2xl grid-cols-1 gap-3 sm:gap-10 md:mt-0 lg:grid-cols-2">
        <div
          className={`rounded-lg bg-white p-5 text-left shadow ${
        ...
        >
          ...
          <p className="pb-1 pt-1 text-sm font-medium text-slate-700">
          ...
          <div className="mt-3 mb-3">
            <div className="mt-3 mb-4 font-semibold text-slate-900">
              ...
              <span className="ml-[6px] font-medium text-zinc-600">
                per month
              </span>
            </div>
        ...
        >
          ...
          <div className="mt-3 mb-3">
            ...
            <button
              ...
              disabled={
                (user.isPremiumPlan && !user.isPremiumPlanEnded) || loading
              }
