      ...
      <Section style={main}>
        <Container style={container}>
          <Section style={{ marginTop: '20px' }}>
            <Img
              src={`${baseUrl}/static/icons/logo.png`}
              width="50"
              height="50"
              alt="Logo"
              style={logo}
          ...
          <Text style={{ ...h1, marginTop: '20px' }}>
            Welcome to Expense.fyi
          </Text>
          <Text style={text}>
            I{"'"}m Gokul, creator of the Expense.fyi, an open-source app to
          ...
          <Text style={{ ...text, margin: '8px' }}>
            4. Finally, spread some word about us.
          </Text>
