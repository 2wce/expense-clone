    ...
    <>
      ...
      >
        ...
        <div className="font-default m-4 mt-4 h-full max-w-3xl pt-3 sm:m-4 sm:mt-8 lg:m-auto">
          ...
          <p className="mt-2">
            Author built the <b>Expense.fyi</b> web application as a{' '}
            <b>Freemium app</b>. This SERVICE is provided by at no cost and is
          ...
          <p className="mt-2">
            ...
            our Terms and Conditions, which are accessible at Expense.fyi unless
        ...
        <div className="font-default relative m-4 mt-3 max-w-3xl pt-3 sm:m-4 lg:m-auto">
          ...
          <p className="mt-2">
            ...
            external sites are not operated by me.
          </p>
          <p className="mt-2">
            Therefore, I strongly advise you to review the Privacy Policy of
            these websites. I have no control over and assume no responsibility
        ...
        <div className="font-default relative m-4 mt-3 max-w-3xl pt-3 sm:m-4 lg:m-auto">
          ...
          <p className="mt-2">
            I encourage parents and legal guardians to monitor their children
        ...
        <div className="font-default relative m-4 mt-3 max-w-3xl pt-3 sm:m-4 lg:m-auto">
          ...
          <p className="mt-2">
            ...
            page. This policy is effective as of 2023-01-01
          </p>
        </div>
