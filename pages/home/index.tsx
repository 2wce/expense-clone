      ...
      >
        <div className="relative m-auto h-[56px] max-w-4xl pt-3">
          <header className="absolute left-0 right-0 top-3 z-20 flex items-center justify-between">
            <Link
              href="/"
              className="flex max-w-[180px] items-center p-3 text-2xl text-black"
            >
              <Logo w="30" h="30" />
            </Link>
          ...
          <div className="mx-auto mt-16 mb-16 max-w-md px-3 text-center sm:max-w-lg sm:px-0">
            ...
            <ul className="mt-6 list-decimal px-4 text-left leading-6 [counter-reset:section] sm:px-2">
              ...
              <li className="before::h-2 font-default mt-4 text-base  sm:text-lg">
                ...
                Expense tracker can provide valuable insights into your spending
                habits, allowing you to make more informed decisions.
              </li>
              <li className="before::h-2 font-default mt-4 text-base  sm:text-lg">
                <b className="font-sans font-bold text-black">
                  Identify overspending:
                </b>{' '}
                Take control of your finances by identifying and reducing
                overspending with an expense tracker.
              </li>
              <li className="before::h-2 font-default mt-4 text-base  sm:text-lg">
                <b className="font-sans font-bold text-black">
                  Real-time visibility:
                </b>{' '}
                Monitor your expenses in real-time, whether you are at home or
                on-the-go, with a user-friendly interface
              </li>
            </ul>
          </div>
        </div>
        ...
        {features.map(({ name, demoUrl }) =>
          demoUrl ? (
            <link key={name} rel="preload" as="video" href={demoUrl} />
          ) : null
        )}
      </div>
    </>
