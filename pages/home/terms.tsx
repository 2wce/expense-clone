      ...
      >
        <div className="relative m-auto h-[40px] max-w-4xl pt-3">
          <header className="absolute left-0 right-0 top-3 z-20 flex items-center justify-between">
            <Link
              href="/"
              className="flex h-[40px] max-w-[180px] items-center p-3 text-2xl"
            >
              <Logo />
            </Link>
          </header>
        ...
        <div className="absolute inset-x-0 top-0 z-10 h-40 overflow-hidden text-slate-600/40 opacity-10 [mask-image:linear-gradient(to_top,transparent,white)]">
          <div className="">
            <svg
              className="absolute inset-0 top-0 h-full w-full text-gray-800"
        ...
        <div className="font-default m-4 mt-4 h-full max-w-3xl pt-3 sm:m-4 sm:mt-8 lg:m-auto">
          ...
          <p className="mt-2">
            ...
            property rights related to it, still belong to . is committed to
            ensuring that the app is as useful and efficient as possible.
          </p>
          <p className="mt-2">
            For that reason, we reserve the right to make changes to the app or
            to charge for its services, at any time and for any reason. We will
            never charge you for the app or its services without making it very
            clear to you exactly what you{'’'}re paying for. The Expense.fyi app
          ...
          <p className="mt-2">
            ...
            security features and it could mean that the Expense.fyi app won
            {"'"}t work properly or at all. You should be aware that there are
            certain things that will not take responsibility for. Certain
          ...
          <p className="mt-2">
            ...
            provider, but cannot take responsibility for the app not working at
            full functionality if you don{"'"}t have access to Wi-Fi, and you
            don{"'"}t have any of your data allowance left. If you{"'"}re using
            the app outside of an area with Wi-Fi, you should remember that the
          ...
          <p className="mt-2">
            ...
            avail the Service, cannot accept responsibility. With respect to{' '}
            {"'"}s responsibility for your use of the app, when you{"'"}re using
            the app, it{"'"}s important to bear in mind that although we
            endeavor to ensure that it is updated and correct at all times, we
            do rely on third parties to provide information to us so that we can
            make it available to you. accepts no liability for any loss, direct
            ...
            app. The app is currently available on – the requirements for the
            system(and for any additional systems we decide to extend the
            availability of the app to) may change, and you{"'"}ll need to
            download the updates if you want to keep using the app. does not
            promise that it will always update the app so that it is relevant to
            you and/or works with the version that you have installed on your
            device.
          </p>{' '}
          <p className="mt-2">
        ...
        <div className="font-default m-4 mt-4 max-w-3xl pt-3 sm:m-auto">
          <h2 className="mb-3 mt-2 text-2xl font-extrabold leading-6">
        ...
        <div className="font-default relative m-4 mt-3 mb-20 max-w-3xl pt-3 sm:m-auto sm:mb-20">
          ...
          <p className="mt-2">
            ...
            <a
              className="border-b-[1px] border-black pb-[1px]"
              href="mailto:hello@expense.fyi."
            >
              hello@expense.fyi.
            </a>
          </p>
